...
void GeneGlobDriver(GTMatrix& gtMatrix, TDIMatrix& geMatrix, const string outFileName, const float v0 ){
    ...
    vector<float> lnGlobalPriors (nGT,0.0); //define lnGlobalPriors with size of nGT and initialized to 0
...
//            float lnData = TFscore + DFscore + lntumorMutPriors[gt];
            float lnData = TFscore + lnGlobalPriors[gt];
