...
void PanCanTDIC(PanCanGTMatrix& gtMatrix, TDIMatrix& geMatrix, map<string, 
        ...
        int realNumOfCanTypes, int  *&d_cancerTypes,  bool *&d_gtDataMatrix, bool *&d_geDataMatrix){
...
//    float* tumorPosteriorMatrix = new float[nGT * nGE]();
    ...
    PanCanTDIC_GeLoop<<<grid, block>>>(nGE, nGT, nTumors, realNumOfCanTypes, d_tumorGeIndices, d_tumorGtIndices, d_tumorGlobDriverIndices, d_cancerTypes, d_gtDataMatrix, d_geDataMatrix, d_lntumorMutPriors ,d_tumorPosteriorMatrix, d_tumorPosteriorMatrixC);
