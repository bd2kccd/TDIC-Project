 ...
 * @param int realNumOfCanTypes This is the actual number of cancer type obtained at runtime
 ...
 */     
__global__ void PanCanTDIC_GeLoop(int nGE, int nGT, int nTumors, int realNumOfCanTypes, int* tumorGeIndices,  int* tumorGtIndices, int* tumorGlobDriverIndices, int* canTypes, bool* gtDataMatrix, bool* geDataMatrix, float* lntumorMutPriors, float* tumorPosteriorMatrix, float* tumorPosteriorMatrixC)
{
