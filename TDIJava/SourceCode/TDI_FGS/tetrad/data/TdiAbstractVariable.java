...
import tetrad.util.NamingProtocol;
 ...
 */
public abstract class TdiAbstractVariable implements TdiVariable {
    ...
    //Add TDI gene type as class property  on 01/04/2017 by mxj
     ...
     */
    TdiAbstractVariable(String name) {
        if (name == null) {
...
//        }
    ...
    public final void setName(String name) {
        if (name == null) {
            throw new NullPointerException(
                    "TdiAbstractVariable name must not be null.");
        }
    ...
    public abstract TdiNode like(String name);


    public int compareTo(Object o) {
        TdiNode node = (TdiNode) o;
