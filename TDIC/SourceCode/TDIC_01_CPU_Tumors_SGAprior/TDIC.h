...
//#endif
    ...
    void TDIC(GTMatrix&, TDIMatrix&, map<string, string> & , vector<int>  tumorGtIndices, vector<double> gtPriorsTumor, vector<int> tumorGeIndices, const double v0, vector<double>& tumorPosteriorMatrix);
    ...
    double calcFscore(float gt1,  float gt1ge1, float gt1ge0, float gt0, float gt0ge1, float gt0ge0 );
    double calcA0Fscore(float gt1,  float gt1ge1, float gt1ge0, float gt0, float gt0ge1, float gt0ge0 );
