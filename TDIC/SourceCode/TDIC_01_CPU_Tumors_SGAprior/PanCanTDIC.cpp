...
void PanCanTDIC(PanCanGTMatrix& gtMatrix, TDIMatrix& geMatrix, map<string, 
   ...
   //calculate lntumorPriors
    ...
    vector<double> tumorPosteriorMatrixC(nGT * nGE * 2, 0.0);//save cancer type the same(1) or not(0) tumorPosteriorMatrix
...
//                for(int b=0; b<=1; b++)
//                    for(int c=0; c<=1; c++)
//                          for (int i=0; i<=1; i++) //cancer type can be 0 or 1
...
//            
            ...
            double lnDataC[2] = {0.0};
            double TFscoreC[2] = {0.0};
            double DFscoreC[2] = {0.0};
            double pGT1GE1C[2] = {0.0};
            double pGT0GE1C[2] = {0.0};
...
//        float normT = 0.0; //without considering cancer type
        double normC[2] = {0.0};
        double normCT = 0.0; //combination of  cancer type normC[]
