...
public:
    ...
    //nCol is the number of column of GeMatrix, nRow is the number of rows of GeMatrix
    //cCol nRow is defined as public to be used in Cuda memory allocation and copy in TDIC_Main.cpp for linear array mat whose size is nCol*nRow 
    int nCol, nRow;    
protected:
