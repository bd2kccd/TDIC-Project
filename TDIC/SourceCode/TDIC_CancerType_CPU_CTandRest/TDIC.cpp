...
void TDIC(GTMatrix& gtMatrix, TDIMatrix& geMatrix, map<string, 
        string>& mapGlobDrivers, const int tumorID, const string outPath, const double v0){
    // initializations 
...
//                   TD[tVal*2+dVal]++;  
            ...
            */
            ...
            double lnData = TFscore + DFscore + lntumorMutPriors[gt];
            ...
            if(pGT1GE1 <= pGT0GE1)
            {
                tumorPosteriorMatrix[gt* nGE + ge] = -DBL_MAX;
            }
        }
 ...
 * @return 
 */
double calcFscore(double gt1,  double gt1ge1, double gt1ge0, 
    double gt0, double gt0ge1, double gt0ge0 )
{
 ...
 * @return 
 */
double calcA0Fscore(double gt1,  double gt1ge1, double gt1ge0, 
    double gt0, double gt0ge1, double gt0ge0 )
{
 ...
 * @return 
 */
//double calcFscoreMultGT(int* gtm, int* gem, const int nTumors,  const int* gtIndx, const unsigned int nGT, const int geIndx)
//{
