...
void GTMatrix::calcGlobalAlphaPriors()
{
    ...
    allAlphaPriors = new double[nGenes]();
    ...
    {   
        ...
        double gtWeight =   1.0 / ((double)numMutatedGTsForTumor + 1);
 ...
 */
void GTMatrix::calcLnTumorPriors(vector<int>& gtIndx, const double v0, vector<double>& lnTumorPriorAlphas)
{
    ...
    for(int gt = 0; gt < gtIndx.size(); gt++)
    {
        ...
        double result = (1 - v0) * allAlphaPriors[gtIndx[gt]] / sumAlphaPrior;
