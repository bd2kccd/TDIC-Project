...
void GTMatrix::calcGlobalAlphaPriors()
{
    ...
    {   
        ...
        float gtWeight =   1.0 / ((float)numMutatedGTsForTumor+1);
...
//    vector<int*> matrixAsVec;
    vector<bool*> matrixAsVec;
     // by mxj. nCol, nRow are defined as TDIMatrix public class memeber for being used for cuda memory allocation for mat
    nCol = 0;
    nRow = 0;
...
//    mat = new int[(nCol+1) * nRow ]();
    ...
    //nCol is used to pass the size of mat to GPU
	nCol += 1;
