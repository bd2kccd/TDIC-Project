 ...
 * @param int* canTypes     Cancer types array of all tumors
...
//                int tumorCanType = canTypes[t];
                ...
                int theSameCanType = (curCanType == compCanType);//if cancer type is the same, the value = 1
...
//            TE[0]=TE[1] = 0.0;
            //There is no count for C0T0, C1T0, C0T1, C1T1
            for (int i=0; i<=1; i++)
                CT[ i*2 + 0 ] =  0.0;
...
//          
            /*****************************************************************
             *Calculate lnData considering cancel type , save the lnData into lnDataC[1] if the cancer type is the same, else save to linDataC[0]
             */
