...
import tetrad.graph.TdiNode;
import tetrad.graph.NodeEqualityMode;
import tetrad.graph.NodeType;
 ...
 */
public final class TdiDiscreteVariable extends TdiAbstractVariable
     ...
     * categories.
     */
    public TdiDiscreteVariable(String name) {
        super(name);
    }
     ...
     */
    public TdiDiscreteVariable(String name, int numCategories) {
        super(name);
     ...
     */
    public TdiDiscreteVariable(String name, List<String> categories) {
        super(name);
     ...
     * Copy constructor.
     */
    public TdiDiscreteVariable(TdiDiscreteVariable variable) {
     ...
     */
    public static TdiDiscreteVariable serializableInstance() {
        return new TdiDiscreteVariable("X");
    }
...
//        return hashCode;
    ...
    public final boolean equals(Object o) {
        ...
        //AJ
        if (!(o instanceof TdiDiscreteVariable)) {
            return false;
        }
...
//        } else if (equalityType == NodeEqualityMode.Type.NAME) {
        TdiDiscreteVariable variable = (TdiDiscreteVariable) o;
...
//        return getNodeType() == variable.getNodeType();
    ...
    public TdiNode like(String name) {
        TdiDiscreteVariable variable = new TdiDiscreteVariable(name);
