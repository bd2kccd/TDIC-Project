...
public class Edge implements TetradSerializable, Comparable {
     ...
     */
    protected double[] edgeScores = new double[4];

    public double[] getEdgeScores() {
        return this.edgeScores;
    }

    public void setEdgeScores(double[] edgeScores) {
        this.edgeScores = edgeScores;
    }
    
    public void setEdgeScores(double score00, double score01, double score10, double score11) {
