...
def extractTriplets_real(path_in, path_out):
    ...
    # if os.path.isfile(path_out): #if file is not exist, then it fails
    if path_out[-4] == ".":  #determine if it is file by check if the last 4 character of path_out is '.'
        file_out = path_out
...
# extractTriplets_rand(PATH_TDIrandbyfreq, PATH_TripletsRandbyfreq, 4, 5)
# PATH_TDI = "/home/xim33/TDIC_01_CPU_-fGtCM_SGAprior/pairexp/"
# PATH_triplets = "/home/xim33/DataSource/PanCancer13tts_pairExp_extraction/"
# extractTriplets_real(PATH_TDI,PATH_triplets)