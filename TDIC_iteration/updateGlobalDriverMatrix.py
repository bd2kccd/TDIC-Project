...
def updateGlobalDriver(count, file_triplet,file_SGA,file_DEGposteriors,file_DEGtoSGAs,file_GdMatrix):
    ...
    print "The converged EDG rate for current run is: " + str(1-float(numNotConverged)/numDEG) + "\n"
...
#
# updateGlobalDriver(file_triplet,file_SGA,file_DEGposteriors,file_DEGtoSGAs,file_GdMatrix)